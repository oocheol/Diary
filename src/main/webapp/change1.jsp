	...
	<div id="wrapper">
		...
		<article id="work" class="panel">
			...
			<section>
				...
				<form action="PositiveService1" method="post" id="positive1"
	...
	<div id="modal-wrap">
		<div id="mental">
			...
			<p>
				...
				행동을 지적하기보다는 내가 느끼는 것, 내 생각을 중심으로 이야기를 시작합니다. <br>
				<br> <strong>2. 불만이 아니라 소망을 표현합니다.</strong><br> 불만을 표현하는
				것이 아닌, "~했으면 좋겠다"는 소망을 담아 이야기를 합니다. <br>
				<br> <strong>3. 긍정적인 감정 단어를 사용합니다.</strong><br>"~게 표현해준다면
				내가 따뜻함을 느낄 것 같아"와 같이, 소망과 함께 긍정적 단어를 이야기 합니다. <br> <br>
				<button>닫기</button>
